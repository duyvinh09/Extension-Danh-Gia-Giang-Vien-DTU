          ...
          if (currentTab.url.includes('https://mydtu.duytan.edu.vn/sites/index.aspx?p=home_ratingform')) {
              ...
              chrome.tabs.sendMessage(currentTab.id, {
                  ...
                  if (chrome.runtime.lastError) {
                      ...
                      const ratingText = document.querySelector(`#rating option[value="${ratingValue}"]`).textContent;
                      const successMessage = `Đã đánh giá <strong>${ratingText}</strong> thành công!`;
                      showNotification(successMessage, 'success', 'check-circle');
